...
// const variables take NO RAM, they are like #define, but with type info for
// the compiler to use when checking validity of code.
...
extern bool warpMode;

#include "../go-lib/Display2.h"
...
#define SHMOO_COLOR 16
#define BULLET_COLOR 17
#define EBULLET_COLOR 18
#define BOSS_COLOR 19
#define ASSAULT_COLOR 20
#define BOMBER_COLOR 21
#define SCOUT_COLOR 22
#define STAR_COLOR 23
